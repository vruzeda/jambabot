(function() {
  ...
  function postJambaFoodSearch(debugEnabled, slackResponse, username, command) {
	// Custom Search Image ID and Google API key, both generated by Lucas Palma
    var client = googleImages('008202342517029290423:uupudzk-fko', 'AIzaSyAyg0mF1BGwFRjUisljnQRL77XwjtmWB48');
  ...
  function processCommand(debugEnabled, slackRequest, slackResponse) {
    ...
    } else if(/^busca\s+\w+/.test(command)) {
